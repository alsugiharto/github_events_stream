...
- You work on unix system, for windows please look for the windows version for each script in [How to run the solution](#how-to-run-the-solution) and [The API Endpoints](#the-api-endpoints)
